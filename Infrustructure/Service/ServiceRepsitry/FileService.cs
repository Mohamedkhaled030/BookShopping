...
namespace BookShopping.Infrustructure.Service.ServiceRepsitry
{
    public class FileService : IFileService
    {
        ...
        public async Task<string> SaveFile(IFormFile file, string[] allowedExtensions)
        {
            ...
            var path = Path.Combine(wwwPath, "images/BookImg");
        ...
        {
            var wwwPath = _environment.WebRootPath;
            var fileNameWithPath = Path.Combine(wwwPath, "images/BookImg", fileName);
